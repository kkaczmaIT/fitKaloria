...
<div class="container" style="min-height: 70vh;">
    <div class="row">
        <div class="d-none" id="id-website"><?php echo $data['ID']; ?></div>
        <div class="col-12 d-flex justify-content-start">
            <a href="<?php echo getenv("CMS_URL"); ?>websites/websitespanel/<?php echo $data['ID']; ?>" class="btn btn-secondary">Powrót do witryny</a>
        </div>
        <div class="col-12">
            <header>
                <h2 class="mt-3 ml-3">Edycja Witryny</h2>
                ...
                <form method="post">
                    ...
                    <input class="btn btn-primary" id="updated-website-button" type="submit" onclick="updateWebsite(event)" value="Zaktualizuj witrynę">
                </form>
        </div>
            </header>
        </div>
